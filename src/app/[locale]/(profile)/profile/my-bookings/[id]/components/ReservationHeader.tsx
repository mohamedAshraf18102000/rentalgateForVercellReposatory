...
export default function ReservationHeader({
  ...
  return (
    <div className="sticky top-0 z-20 bg-white">
      <div
        className={`flex flex-row  justify-between ${isStatus4 ? "max-md:flex-col max-md:items-start" : "  items-center   sm:items-center"} bg-white gap-3 sm:gap-0 py-3 px-4 sm:py-[15px] sm:px-[18px] border-b-2 border-[#ECEEF2]`}
      >
        <div className="flex items-center gap-2">
          ...
          <div
            className={`px-3 py-1 rounded-md text-xs font-semibold flex items-center gap-2 ${statusConfig.className}`}
          >
            {statusConfig.label}
          </div>
        </div>
