            ...
            <div className="relative">
                ...
                <div className='relative md:absolute md:top-0 md:left-0 md:right-0 md:w-full md:h-full'>
                    ...
                    <div className="md:hidden flex flex-col gap-6 px-4 py-8">
                        ...
                        <div className="flex flex-col justify-center items-center text-center">
                            ...
                            <div className="flex gap-3 justify-center">
                                <a href={contact?.androidLink || ''} target='_blank' className="block w-[140px] sm:w-[160px] h-[44px] sm:h-[52px] hover:scale-105 transition-transform">
                                    <Image
                                ...
                                <a href={contact?.iosLink || ''} target='_blank' className="block w-[140px] sm:w-[160px] h-[44px] sm:h-[52px] hover:scale-105 transition-transform">
                                    <Image
                    ...
                    <div className="hidden md:grid grid-cols-12 gap-8 px-8 py-10 h-full items-center">
                        ...
                        <div className={cn("col-span-7 flex flex-col justify-center items-center text-center", isRTL ? "md:text-right" : "md:text-left")}>
                            <h2 className={cn("text-4xl lg:text-5xl xl:text-[60px] font-bold mb-8 leading-20 text-center")}>
                                {t('appDownload')}
                            </h2>

                            <div className="flex gap-4 justify-center md:justify-start">
                                <a href="#" className="block w-[160px] lg:w-[180px] h-[52px] lg:h-[60px] hover:scale-105 transition-transform">
                                    <Image
                                        src='/shared/Google.png'
                                        alt='Get it on Google Play'
                                        width={180}
