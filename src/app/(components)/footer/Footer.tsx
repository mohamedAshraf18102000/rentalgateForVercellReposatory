...
const footerNav = [
  ...
  { href: '/cars', key: 'booking' as const },
  { href: '/company-quotation', key: 'businessAccount' as const },
  { href: '/profile', key: 'footerPersonal' as const },
];
...
function XTwitterIcon({ className }: { className?: string }) {
  return (
    <svg fillRule="evenodd" viewBox="64 64 896 896" className={className} fill="currentColor" aria-hidden="true">
