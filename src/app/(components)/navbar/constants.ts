...
export const NAVBAR_STYLES = {
  header: 'fixed top-0 z-50 w-full h-[62px] py-[10px] px-[80px] bg-white border-b-[0.5px] border-[#D0D0D0] shadow-[0px_4px_4px_0px_#C0C0C01A] hidden md:flex md:items-center',
...
export const BUTTON_STYLES = {
  primary: 'bg-primary h-[40px] text-white py-[7.5px] px-[14px] font-medium whitespace-nowrap border-0 shadow-none  transition-all rounded-[12px] text-[14px]',
  ...
  homeLinkActive: 'bg-[#ECEEF2] border-1 border-primary rounded-[12px] flex items-center justify-center font-bold!',
  homeLinkInactive: 'hover:bg-gray-100',
  logo: 'w-[65px] h-[65px] p-[7px]',
  userButton: 'bg-primary h-[40px] text-white py-[7.5px] px-[14px] font-medium whitespace-nowrap border-0  transition-all rounded-[12px] flex items-center gap-2 hover:opacity-90',
} as const;
